...
public class MerchandiseMenuJPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextItemName.getText().isEmpty()){ Error.append("Enter Valid Name \n");}
        else{merchandise.setItemName(jTextItemName.getText());
        jTextItemName.setText("");}
        if(jTextPrice.getText().isEmpty()){ Error.append("Enter Price \n");}
        else{merchandise.setItemName(jTextPrice.getText());
        jTextPrice.setText("");}
